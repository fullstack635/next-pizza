...
export default function PizzaModal(props: PizzaModalProps): JSX.Element {
    ...
    return (
        <Base>
            ...
            <Inner>
                <Modal>
                    <CloseContainer>
                        <CloseIcon width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
